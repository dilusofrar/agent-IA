(function () {
  ...
  function renderPersistenceStatus(status) {
    ...
    const d1Integration = d1Mode === "native-binding" ? "Nativa da Cloudflare" : d1Mode === "api" ? "API D1" : "Desativada";
    const r2Integration = r2Mode === "native-binding" ? "Nativa da Cloudflare" : r2Mode === "r2-api" ? "API R2" : "Local";
    const cards = [
      ...
      summaryCard("Integração D1", d1Integration, d1Mode === "native-binding" ? "Detectada automaticamente pelo Worker." : "Modo atual de acesso ao banco principal."),
      summaryCard("Integração R2", r2Integration, r2Mode === "native-binding" ? "Detectada automaticamente pelo Worker." : "Modo atual de acesso ao bucket principal."),
